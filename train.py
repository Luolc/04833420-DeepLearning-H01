...
def main():
    ...
    if args.loss == 'softmax':
        ...
        logits = tf.log(plus_one_abs_logits)
    ...
    loss = 2 * tf.nn.l2_loss(tf.cast(label_onehot, preds.dtype) - preds) + loss_reg
